...
static struct l2_level l2_freq_tbl[] __initdata = {
	...
	[16] = { { 1242000, HFPLL, 1, 0x2E }, 1150000, 1175000, 6 },
	[17] = { { 1296000, HFPLL, 1, 0x30 }, 1150000, 1175000, 6 },
	{ }
};

static struct acpu_level tbl_wild_2100MHz[] __initdata = {
	...
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(11),  950000 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(12),  962500 },
	...
	{ 1, {  1890000, HFPLL, 1, 0x46 }, L2(16), 1137500 },
...
static struct pvs_table pvs_tables[NUM_SPEED_BINS][NUM_PVS] __initdata = {
	[1][1] = { tbl_wild_2100MHz, sizeof(tbl_wild_2100MHz),     0 },
};
